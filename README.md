...
- **0.7.0** (Beta, Current): Modular RAG pipeline, hybrid retrieval, plugin architecture, Azure/Beam integration, basic observability. Not production-ready; for experimentation and prototyping.
...
1.  **Configure Environment**:
    ...
    *   `JINA_API_KEY`: For the default embedding provider.
...
2.  **Launch Stack & Ingest Data**:
    ...
    ```
    You can monitor the logs to see the progress of all services: `docker compose logs -f`.
