        ...
        try:
            ...
            class EmbeddingAdapter:
                ...
                def get_text_embedding_batch(self, texts, **kwargs):
                    return self.model.get_text_embedding_batch(texts, **kwargs)
                    
                async def aget_text_embedding(self, text, **kwargs):
                    return await self.model.aget_text_embedding(text, **kwargs)
                    
                async def aget_text_embedding_batch(self, texts, **kwargs):
                    return await self.model.aget_text_embedding_batch(texts, **kwargs)
            ...
            self.aclient = AsyncQdrantClient(url=self.qdrant_url)
