...
class HyDEPlugin:
    ...
    version = "0.2.0"
    description = "Hypothetical Document Embeddings (HyDE) query expansion"

    def register(self, pipeline: Any) -> None:
        """Register HyDE expansion with the pipeline."""
        pipeline.hyde_expand = expand_query_hyde_async
        logger.info("Registered HyDE expander with pipeline")


# Create plugin instance
hyde_plugin = HyDEPlugin() 